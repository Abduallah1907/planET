                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="ml-auto button-container">
                        ...
                        <Dropdown>
                            ...
                            <Dropdown.Menu >
                                <Dropdown.Item href="#" onClick={() => handleFlagChange('ar', 'ar')}>
                                    <img src={EgyptFlag} alt="Egypt Flag" width="30" height="30" /> Arabic
                                </Dropdown.Item>
                                <Dropdown.Item href="#" onClick={() => handleFlagChange('fr', 'fr')}>
                                    <img src={FranceFlag} alt="France Flag" width="30" height="30" /> Français
                                </Dropdown.Item>
                                <Dropdown.Item href="#" onClick={() => handleFlagChange('en', 'en')}>
                                    <img src={UKFlag} alt="UK Flag" width="30" height="30" /> English
                                </Dropdown.Item>
                                <Dropdown.Item href="#" onClick={() => handleFlagChange('de', 'de')}>
                        ...
                        <Dropdown className="currency-dropdown">
                            ...
                            <Dropdown.Menu >
                                <Dropdown.Item href="#" onClick={() => handleCurrencyChange('USD')}>{t('usd')}</Dropdown.Item>
                                <Dropdown.Item href="#" onClick={() => handleCurrencyChange('EUR')}>{t('eur')}</Dropdown.Item>
                                <Dropdown.Item href="#" onClick={() => handleCurrencyChange('EGP')}>{t('egp')}</Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
