        ...
        <Navbar className="top-bar" variant="dark">
            ...
            <div className="button-container">
                ...
                <Dropdown className="currency-dropdown">
                    <Dropdown.Toggle className='btn-text btn-main dropdown-toggle'>{t('egp')}</Dropdown.Toggle>
                    <Dropdown.Menu>
                ...
                <Button variant="" onClick={() => navigate(`/Help`)} className="btn-help btn-margin"></Button>
                <Button variant="" className="btn-text">{t('join_us')}</Button>
                <Button variant="" onClick={() => navigate(`/Registeration`)} className="btn-main">{t('register')}</Button>
                <Button variant="" onClick={() => navigate(`/Login`)} className="btn-main btn-margin">{t('sign_in')}</Button>
            </div>
        </Navbar>
    );
};
