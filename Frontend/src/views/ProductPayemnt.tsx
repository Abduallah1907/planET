    ...
    const handleConfirmPayment = async () => {
        if (paymentMethod === 'Wallet') {
            ...
            try {
                ...
                dispatch(clearCart());
                showToast('Payment successful', ToastTypes.SUCCESS);
                navigate('/tourist/Profile');
            } catch (error) {
                console.error('Error booking activity:', error);
                showToast('Error confirming payment  '+error, ToastTypes.ERROR);
            }
        }
    };
            ...
            <Row className="justify-content-center mt-5">
                <Col sm={12} md={8} lg={6}>
                    ...
                    <Form>
                        ...
                        <Button variant='main-inverse' className="Confirm-button w-100" onClick={handleConfirmPayment}>
                            Confirm Payment
                        </Button>
                    </Form>
                </Col>
