...
const MyItineraryBookings: React.FC = () => {
   const Tourist = useAppSelector((state) => state.user);
    ...
    return (
        <div>
            <Nav className="bookingTabs" defaultActiveKey="/MyItineraryBookings/upcoming">
                <Nav.Item>
                    <Nav.Link as={NavLink} to="/MyItineraryBookings/upcoming">Upcoming Itineraries</Nav.Link>
                </Nav.Item>
                <Nav.Item>
                    <Nav.Link as={NavLink} to="/MyItineraryBookings/past">Past Itineararies</Nav.Link>
                </Nav.Item>
            </Nav>
            {loading && <p>Loading...</p>}
