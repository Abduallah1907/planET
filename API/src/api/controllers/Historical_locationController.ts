...
export class Historical_locationController {
  ...
  public async getHistorical_locationByIDForGovernerController(
    req: any,
    res: any
  ) {
    const historical_locationService: Historical_locationService =
  ...
  public async getFilterComponents(req: any, res: any) {
    ...
    const filterComponents =
      await historical_locationService.getFilterComponentsService(role);
  ...
  public async getComments(req: any, res: any) {
    ...
    const historical_locationService: Historical_locationService =
      Container.get(Historical_locationService);
    const comments = await historical_locationService.getCommentsService(
      historical_location_id
    );
