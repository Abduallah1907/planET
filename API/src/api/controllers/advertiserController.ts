...
export class AdvertiserController {
  ...
  public async createAdvertiserController(req: any, res: any) {
    const advertiserService: AdvertiserService = Container.get(AdvertiserService);
    const advertiserData = req.body as IAdvertiser;
    const advertiser = await advertiserService.createAdvertiserService(advertiserData);
  ...
  public async createAdvertiserMainController(req: any, res: any) {
    ...
    const advertiser = await advertiserService.createAdvertiserMainDataService(advertiserData);
    res.status(advertiser.status).json(advertiser);
  }
  ...
  public async getAdvertiserByEmailController(req: any, res: any) {
    ...
    const advertiserService: AdvertiserService = Container.get(AdvertiserService);
    const advertiser = await advertiserService.getAdvertiserByEmailService(email);
    res.status(advertiser.status).json(advertiser);
  }
  //Get all Advertisers
  ...
  public async getAdvertiserByUserIDController(req: any, res: any) {
    ...
    const advertiserService: AdvertiserService = Container.get(AdvertiserService);
    const advertiser = await advertiserService.getAdvertiserByUserIDService(userID);
    res.status(advertiser.status).json(advertiser);
  }
  ...
  public async getAdvertiserByActivityIDController(req: any, res: any) {
    ...
    const advertiserService: AdvertiserService = Container.get(AdvertiserService);
    const advertiser = await advertiserService.getAdvertiserByActivityIDService(activityID);
    res.status(advertiser.status).json(advertiser);
  }
  //Update Advertiser
  public async updateAdvertiserController(req: any, res: any) {
    ...
    const advertiserService: AdvertiserService = Container.get(AdvertiserService);
    const advertiser = await advertiserService.updateAdvertiserService(email, file, req.body);
    res.status(advertiser.status).json(advertiser);
  }
  //Delete Advertiser
  ...
  public async deleteAdvertiserAccountRequest(req: Request, res: Response) {
    const { email } = req.params;
    const advertiserService: AdvertiserService = Container.get(AdvertiserService);
    const advertiser = await advertiserService.deleteAdvertiserAccountRequest(email);
    res.status(advertiser.status).json(advertiser);
  }
}
