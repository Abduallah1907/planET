...
export default (app: Router) => {
  ...
  router.delete(
    "/deleteAdvertiserAccountRequest/:email",
    advertiserController.deleteAdvertiserAccountRequest
  );
  router.get("/getSalesReport/:email", advertiserController.getSalesReport);
};
