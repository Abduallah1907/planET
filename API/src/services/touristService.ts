...
export default class TouristService {
  ...
  public async bookItineraryService(email: string, itinerary_id: string, time_to_attend: Date) {
  ...
  public async bookHistoricalLocationService(email: string, historical_location_id: string) {
